#This code script was used to process upper limb accelerometry data from the study, Mapping Upper Limb Performance (PMC844293),
#for the project:
...
for(s in 1:nrow(DATAPROCESSINGLOG)) {
    ...
    #Create time stamp and add to left and right 30 Hz file
    HERTZ_30 <- 30
